...
add wave -noupdate -expand -subitemconfig {/hdl_top/master_agent_bfm_h/master_drv_bfm_h/drive_msb_first_pos_edge/cfg_pkt.t2c {-color Coral -itemcolor Yellow}} /hdl_top/master_agent_bfm_h/master_drv_bfm_h/drive_msb_first_pos_edge/cfg_pkt
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {28 ns} 1} {{Cursor 2} {167 ns} 1} {{Cursor 3} {548 ns} 1} {{Cursor 4} {1472 ns} 0}
